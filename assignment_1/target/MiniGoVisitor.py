...
class MiniGoVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by MiniGoParser#star_dot_func_call.
    def visitStar_dot_func_call(self, ctx:MiniGoParser.Star_dot_func_callContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by MiniGoParser#star_lhs_dot.
    def visitStar_lhs_dot(self, ctx:MiniGoParser.Star_lhs_dotContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by MiniGoParser#star_dot_dim.
    def visitStar_dot_dim(self, ctx:MiniGoParser.Star_dot_dimContext):
        return self.visitChildren(ctx)
